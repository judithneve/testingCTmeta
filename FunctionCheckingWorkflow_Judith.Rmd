...
2. How to deal with both Gamma and SigmaVAR being specified - which one is more important? What if one of them is broken? What if they don't match?

Notes:

* it appears that neither can be broken - otherwise, we get errors.

* if both are specified, it seems Gamma takes precedence
...
5. When PhiPlot = TRUE, the plot prints twice

6. What exactly should be in N?